...
def build_model(model_type, num_classes, pretrained_dir=None):
    if model_type == 'swin_base_patch4_window7_224':
    ...
    elif model_type == 'swin_base_patch4_window14_224':
        model = SwinTransformer(img_size=224,
                                patch_size=4,
                                in_chans=3,
                                num_classes=num_classes,
                                ...
                                patch_norm=True,
                                use_checkpoint=False)
    elif model_type == 'swin_base_patch4_window14_224_dpr1':
        model = SwinTransformer(img_size=224,
                                patch_size=4,
                                in_chans=3,
                                num_classes=num_classes,
                                ...
                                patch_norm=True,
                                use_checkpoint=False)
    elif model_type == 'swin_base_patch4_window14_224_dpr5':
        model = SwinTransformer(img_size=224,
                                patch_size=4,
                                in_chans=3,
                                num_classes=num_classes,
        ...
        model = SwinTransformer(img_size=224,
                                ...
                                use_checkpoint=False,
                                double_output=True)
    elif model_type == 'swin_mini1_patch4_window7_224':
        model = SwinTransformer(img_size=224,
                                patch_size=4,
                                in_chans=3,
                                num_classes=num_classes,
                                ...
                                use_checkpoint=False,
                                double_output=True)
    elif model_type == 'swin_mini2_patch4_window7_224':
        model = SwinTransformer(img_size=224,
                                patch_size=4,
                                in_chans=3,
                                num_classes=num_classes,
                                ...
                                use_checkpoint=False,
                                double_output=True)
    elif model_type == 'swin_micro_patch4_window7_224':
        model = SwinTransformer(img_size=224,
                                patch_size=4,
                                in_chans=3,
                                num_classes=num_classes,
